...
void EDBR2PKUTree::Higgs_Matching_taulep() {
    ...
    if( R4q_max<1 && R3q_max<1 && R2q_max<1 && Rlqq_max<1 && Rlq_max<1 && w_max<1 && z_max<1 && t_max<1 && gKK_g_max<0){
        u_max=1;
    }
    ...
    if(R4q_min<1 && R3q_min<1 && R2q_min<1 && Rlqq_min<1 && Rlq_min<1 && w_min<1 && z_min<1 && t_min < 1 && gKK_g_min < 1){
        u_min=1;
    }
...
void EDBR2PKUTree::Higgs_Matching_taudecay() {
    ...
    Rlqq_max = (Rlqq_emu_taudecay_max == 1 || Rlqq_tau_taudecay_max == 1);
    Rlq_max = Rlq_taudecay_max;
    u_max = ( R4q_max < 1 && R3q_max < 1 && R2q_max < 1 && Rlqq_max < 1 && Rlq_max < 1 && gKK_g_max < 1 && w_max < 1 && z_max < 1 && t_max < 1 );

    R3q_min = R3q_td_min;
    R2q_min = (R2q_min == 1 || R2q_qtau_taudecay_min == 1 || R2q_tautau_taudecay_min == 1);
    Rlqq_min = (Rlqq_emu_taudecay_min == 1 || Rlqq_tau_taudecay_min == 1);
    Rlq_min = Rlq_taudecay_min;
    u_min = ( R4q_min < 1 && R3q_min < 1 && R2q_min < 1 && Rlqq_min < 1 && Rlq_min < 1 && gKK_g_min < 1 && w_min < 1 && z_min < 1 && t_min < 1);
    ...
    if(Nj8 == 3){
        ...
        Rlqq_mid = (Rlqq_emu_taudecay_mid == 1 || Rlqq_tau_taudecay_mid == 1);
        Rlq_mid = Rlq_taudecay_mid;
        u_mid = ( R4q_mid < 1 && R3q_mid < 1 && R2q_mid < 1 && Rlqq_mid < 1 && Rlq_mid < 1 && gKK_g_mid < 1 && w_mid < 1 && z_mid < 1  && t_mid < 1);
    }
